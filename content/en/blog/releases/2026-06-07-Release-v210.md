...
If the network was interrupted while downloading new OCR languages, the app might crash. This only happened if the languages has not been downloaded before.
